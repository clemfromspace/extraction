...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_rewriting_relative_urls(self):
        ...
        extracted = self.extractor.extract(
            LETHAIN_COM_HTML,
            source_url="http://lethain.com/digg-v4-architecture-process/"
        )
    ...
    def test_technique_facebook_meta_tags(self):
        ...
        self.assertTrue(
            ...
            "A group of U.S. Marines, under command of a renegade general, take over Alcatraz and "
            "threaten San Francisco Bay with biological weapons."
        )
    ...
    def test_technique_twitter_meta_tags(self):
        ...
        self.assertEqual(
            extracted.image,
            "http://graphics8.nytimes.com/images/2012/02/19/us/19whitney-span/19whitney-span-article.jpg"
        )
        self.assertEqual(
            extracted.images,
            ["http://graphics8.nytimes.com/images/2012/02/19/us/19whitney-span/19whitney-span-article.jpg"]
        ...
        self.assertTrue(
            extracted.description,
            "NEWARK - The guest list and parade of limousines with celebrities emerging from them seemed more suited"
            " to a red carpet event in Hollywood or New York than than a gritty stretch of Sussex Avenue near the fo"
            "rmer site of the James M. Baxter Terrace public housing project here."
        )
        self.assertEqual(len(extracted.descriptions), 1)
    ...
    def test_technique_semantic_tags(self):
        ...
        self.assertEquals(
            ...
            "A month ago history reset with the second launch of Digg v1, "
            "and memories are starting to fade since much of the Digg team "
            "joined SocialCode four months ago, so it seemed like a good ti"
            "me to describe the system and team architecture which ran and "
            "developed Digg.com from May 2010 until May 2012.".split()
        )
    ...
    def test_example_lethain_com_technique(self):
        ...
        self.assertEquals(
            extracted.description.split(),
            "A month ago history reset with the second launch of Digg v1, "
            "and memories are starting to fade since much of the Digg team joined SocialCode four "
            "months ago, so it seemed like a good time to describe the system and team architecture which "
            "ran and developed Digg.com from May 2010 until May 2012.".split()
        )
